...
| R21 | The early-progression token is `boundType: Loot` and untradable. That differs from the three existing project tokens (95214 / 95215 / 95216, all `boundType: None`), so it gets a divergence-log row when authored |
